...
dumpStart = [-2.7159619999999975, -22.355083, 1.0];
...
mesh.y = [mesh.y (7.287966333333332:2.0:24.306297666666666) + 0];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
mesh.x = [mesh.x linspace(-2.712628666666664,52.99906966666667,0.0) + 0];
...
CSX = SetMaterialProperty( CSX, 'air', 'Epsilon', 1.0, 'Kappa', 0.0);
...
mesh.x = [mesh.x (57.87504133333333:2.0:75.51928766666667) + 0];
mesh.y(mesh.y >= 7.287966333333332 & mesh.y <= 24.306297666666666) = [];
mesh.y = [mesh.y (7.287966333333332:2.0:24.306297666666666) + 0];
